...
{
    public class NSCountryController : Controller
    {
        ...
        // GET: NSCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: NSCountry/Create
