 ...
 * 
 *  Membership Type Controller: Allows access to database for Creation, Edits, Viewing, and Deleting
 * 
...
{
    public class NSMembershipTypeController : Controller
    {
        private readonly SailContext _context;

        public NSMembershipTypeController(SailContext context)
        {
            _context = context;
        }

        // GET: NSMembershipType
        public async Task<IActionResult> Index()
        {
            return View(await _context.MembershipType.ToListAsync());
        }

        // GET: NSMembershipType/Details/5
        ...
        // GET: NSMembershipType/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: NSMembershipType/Create
        ...
        // POST: NSMembershipType/Delete/5
